...
class PieChartComponent extends React.Component {
  constructor(props) {
    super(props);
    this.getUniqueColor = this.getUniqueColor.bind(this);
  }
  ...
  render() {
    const { categoryData, selectedDistrict, width = 400, height = 400 } = this.props;
      ...
      datasets: [
        {
          ...
          backgroundColor: pieData.map((_, index) => this.getUniqueColor(index)),
          hoverBackgroundColor: pieData.map((_, index) => this.getUniqueColor(index)),
        },
      ],
    };
