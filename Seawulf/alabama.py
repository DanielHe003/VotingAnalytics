...
def seawulf(working_directory, output_path, state, data, num_plans, num_districts):
    ...
    all_results_gdf.to_file(output_path + f"{state}_district_plans.geojson", driver="GeoJSON")
    ...
    all_plan_summary_df.to_json(output_path + f"{state}_ensemble_summary.json", orient="records", lines=True)
...
if __name__ == "__main__":
    ...
    seawulf(current_directory, os.path.join(current_directory, ""), "AL", alabama_data, 250, 7)
