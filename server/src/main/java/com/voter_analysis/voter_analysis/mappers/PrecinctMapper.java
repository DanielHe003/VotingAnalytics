...
public interface PrecinctMapper {
    ...
    default FeatureDTO toFeatureDTO(Precinct precinct,
                                    Map<String, DemographicHeatData> demographicDataMap,
                                    EconomicHeatData economicData,
                                    RegionTypeHeatData regionTypeData,
                                    PovertyHeatData povertyData,
                                    PoliticalIncomeHeatData politicalIncomeData) {
        if (precinct == null) {
            return null;
        }
